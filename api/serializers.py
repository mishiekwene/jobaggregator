...
class JobSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        'sal_freq':validated_data.get('sal_freq', 'null'), 'state':validated_data.get('state', 'null'), 'county':validated_data.get('county', 'null'), 'date_posted':validated_data.get('date_posted', 'null'), 'city': validated_data.get("city", "null")})
        return job
